...
for (const [name, change, expected] of [
  ...
  try {
    const result = { sourceSha: "0".repeat(40), worktreeDirty: false, state: "COMPLETED", nativeToSolana: "COMPLETED",
      solanaToNative: "COMPLETED", noPerTransferKingPepeTeamApproval: true, checks: { pass: 25, fail: 0, passed: [
        ...
        "AUTOMATIC_ON_CHAIN_WITHDRAWAL_DISCOVERY_WITHOUT_CLIENT_SUBMISSION",

...
export async function runLocalNativeReorg(repoRoot) {
  ...
  return { sourceScope: "NATIVE_TO_SOLANA_CORE", infrastructure: result.state, nativeReorg: result.nativeReorg,
    fullNativeToSolanaE2e: result.fullNativeToSolanaE2e, failure, productionReady: false, mainnetActivation: "DISABLED" };
}

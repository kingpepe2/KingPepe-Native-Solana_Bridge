...
| Native restart recovery | Original TEST chain restored after WSL session retirement; cached RPC cookie caused HTTP 401 and a durable pause. Cookie refresh correction requires current-source CI and reviewed pause recovery before healthy operation is claimed |

...
At that historical review, main identified this commit (2026-07-30, Sui rate-limit fixes).
...
| --- | --- | --- |
| solana/programs/example-native-token-transfers: manager, inbox/outbox, rate_limit, transfer/redeem/release | Reference-only Manager, claim and one-way claim and replay boundaries | Native burn verification and burn/mint journal are original KingPepe code |
...
UTXO verification, Taproot signing, recovery or burn/mint conservation accounting.

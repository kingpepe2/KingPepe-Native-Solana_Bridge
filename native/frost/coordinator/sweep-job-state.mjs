...
export function validateSweepJobIntent(input, policy) {
  ...
  const expected = { purpose: "RESERVE_SWEEP", nativeNetwork: "regtest", nativeGenesisHash: p.nativeGenesis,
    ...
    mint: p.mint, keyEpoch: p.keyEpoch, recipientScriptPubKeyHex: "5120" + p.frostPublicKeyHex,
    changeScriptPubKeyHex: "5120" + p.frostPublicKeyHex, changeAtomic: "0", pauseDeposits: false, hardStop: false };

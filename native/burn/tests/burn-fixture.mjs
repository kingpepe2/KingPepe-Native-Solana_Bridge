...
export function burnFixture({mainnet=false}={}) {
  ...
  if(mainnet)beginMainnetControlled(state,{destinationHex:binding.destination,nonce:binding.nonce,amountAtomic:'100000'});

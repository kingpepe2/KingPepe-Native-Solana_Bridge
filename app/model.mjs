...
export function checkQuote(quote, input) {
  if (!quote || !/^[0-9a-f]{64}$/u.test(quote.operationId) || quote.direction !== "NativeToSolana" || quote.amountAtomic !== input.amountAtomic ||
      quote.recipient !== input.recipient || quote.request?.nonceHex !== input.nonceHex ||

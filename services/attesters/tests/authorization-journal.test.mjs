...
function fixture(t) {
  const v = JSON.parse(readFileSync(new URL("../../../solana/modules/bridge-messages/vectors/canonical-borsh-v3.json", import.meta.url))).vectors.find(x => x.name === "deposit-claim-v3");

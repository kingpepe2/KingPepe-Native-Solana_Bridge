...
function encodeBridgeInitialize({
  ...
  decimals, nativeDecimals, policyEpoch, keyEpoch, depositsPaused, hardStop, mainnetActivationEnabled,
}) {
  ...
  return encodeBridgeAbi("BridgeInitialize", { tag: BRIDGE_INSTRUCTION_INITIALIZE,
    ...
    policy: { policyEpoch, keyEpoch, depositsPaused, hardStop, mainnetActivationEnabled } });
}

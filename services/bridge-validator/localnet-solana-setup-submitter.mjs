...
function normalizeSetupSubmitterConfig(config) {
  ...
  return Object.freeze({
    ...
    protocolId: checkedU32(value.protocolId, "protocolId"),
    nativeNetwork: checkedU32(value.nativeNetwork, "nativeNetwork"),
    nativeGenesisHex: normalizeHash32(value.nativeGenesisHex, "nativeGenesisHex"),
...
function normalizeSetupRequest(config, request) {
  ...
  const normalized = Object.freeze({
    ...
    nativeGenesisHex: config.nativeGenesisHex,

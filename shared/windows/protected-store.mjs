...
const PURPOSES = Object.freeze(["frost-state", "attester-seed", "attester-authorizations", "coordinator-signing", "service-auth", "signer-fence", "global-integrity", "chain-progress"]);

...
const reports = {
  ...
  BRIDGE_VALIDATOR: ["IMPOSSIBLE_OPERATION_STATE"], NATIVE_OBSERVER: ["NATIVE_DEEP_REORG", "NATIVE_GENESIS_CHANGED", "FINALIZED_NATIVE_CONFLICT"],
  SOLANA_OBSERVER: ["SOLANA_GENESIS_CHANGED", "SOLANA_DEPLOYMENT_CHANGED", "FINALIZED_SOLANA_CONFLICT"],

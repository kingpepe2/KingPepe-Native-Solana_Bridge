...
const reports = {
  ...
  COORDINATOR: ["SIGNING_TRANSCRIPT_CONFLICT"], ATTESTER_A: ["CONFLICTING_RESERVE_EVIDENCE", "ATTESTER_JOURNAL_INTEGRITY"], ATTESTER_B: ["CONFLICTING_RESERVE_EVIDENCE", "ATTESTER_JOURNAL_INTEGRITY"],

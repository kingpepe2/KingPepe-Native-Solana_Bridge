...
export const INTEGRITY_ROLES = Object.freeze([
  ...
  "BRIDGE_VALIDATOR", "NATIVE_OBSERVER", "SOLANA_OBSERVER", "RELAYER", "RECONCILIATION", "INDEXER", "FEE_PAYER",
]);
const permissions = {
...
const reports = {
  ...
  FEE_PAYER: ["FEE_PAYER_KEY_INTEGRITY", "FEE_PAYER_DEPLOYMENT_CHANGED"],
};

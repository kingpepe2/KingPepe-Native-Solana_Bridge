...
export const BRIDGE_INPUT_SCHEMAS = Object.freeze({
  NativeSigningIntent: [31, s({ protocol: "string", mode: "string", purpose: "string", nativeNetwork: "string",
    nativeGenesisHash: h, solanaDeployment: h, bridgeProgramId: h, transceiverProgramId: h, mint: h,
    keyEpoch: "u32", signingRequestId: h, operationId: h, proofFingerprint: h,
    ...
    pauseDeposits: "bool", hardStop: "bool" })],

...
const policy = struct({ policyEpoch: "u32", keyEpoch: "u32", depositsPaused: "bool",
  hardStop: "bool", mainnetActivationEnabled: "bool" });
...
export const BRIDGE_ABI_SCHEMAS = Object.freeze({
  BridgeConfig: [config, 255],
  BridgeInitialize: [struct({ tag: "u8", binding, policy }), 207],
  MainnetMode: [struct({ tag: "u8", mode: "u8" }), 2],
  BridgeState: [struct({ ...header, state: "u8", config, mintedSupply: "u128" }), 281],
  DepositClaim: [struct({ ...header, operationId: h, messageDigest: h, amountAtomic: "u64", recipient: destination }), 211],
  DepositReplay: [struct({ ...header, operationId: h, messageDigest: h }), 73],
  BurnReplay: [struct({ ...header, operationId: h, messageDigest: h }), 73],
